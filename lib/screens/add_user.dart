              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Slack",
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 10),
                        FormHelper.inputFieldWidget(context, "slack", "Slack",
                            (onValidateVal) {
                          if (onValidateVal.isEmpty) {
                            return 'Slack cant be empty';
                          }
                          return null;
                        }, (onSavedVal) {
                  ...
                  Container(
                      ...
                      child: Text("Role Tidak Boleh Kosong")),
                  Center(
                    ...
                    if (validateAndSave()) {
                      ...
                      print(user.toJson());
                      addUser().then((value) => Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (context) => TableUser()),
                          (route) => false));
                    }
                  }, borderColor: bluePrimaryColor, btnColor: bluePrimaryColor))
                ],
              )),
        ));
  }
